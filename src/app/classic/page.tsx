...
/**
 * The original landing page, kept.
 *
 * Superseded at `/` by the demo-request version, but preserved intact so the
 * previous positioning can be read back, compared, or restored — a copy change
 * is a decision worth being able to reverse.
 */
export const metadata = {
  title: "Context Window — original landing",
